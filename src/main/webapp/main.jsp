    ...
    <div class="container mt-3">
        <div class="row mt-3">
            <div class="col-12">
                ...
                <button type="button" class="btn btn-sm bg-warning text-bg-secondary" data-bs-toggle="modal" style="background-color: green">Add news</button>
        ...
        <div class="row mt-3">
            <div class="col-12">
                ...
                %>
                        <div class="card mb-3 border border-info" style="max-width: 600px;">
                            <div class="row g-0">
                                <div class="col-md-8">
                                    <div class="card-body">
